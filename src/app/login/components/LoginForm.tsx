    ...
    <form className="space-y-6 mt-6" onSubmit={handleSubmit} dir="rtl">
      ...
      <div className="group">
        ...
        <input
          ...
          className="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 group-hover:shadow-md"
        />
      </div>
